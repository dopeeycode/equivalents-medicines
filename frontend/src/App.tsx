...
export function App() {
  return (
    <main className="antialiased bg-dots bg-center bg-no-repeat h-screen flex items-center justify-center bg-[#0E0D12]">
       <div className="flex items-center py-4 px-4 sm:w-1/2 w-full flex-col gap-6">
        ...
        <Button className="bg-zinc-900 hover:bg-zinc-800">{content.mainButtonCta}</Button>
